Blockly.Python['ultrasonic_read'] = function(block) {
  Blockly.Python.definitions_['import_ultrasonic'] = 'import UltrasonicMod';

  var dropdown_echo = block.getFieldValue('Tx');

  var code = `UltrasonicMod.read(${dropdown_echo})`;
  return [code, Blockly.Python.ORDER_NONE];
};
Blockly.Python['gps_setup'] = function(block) {
  Blockly.Python.definitions_['import UltrasonicMod'] = 'import UltrasonicMod';
...
Blockly.Python['gps_is_ready'] = function(block) {
  Blockly.Python.definitions_['import UltrasonicMod'] = 'import GPS';
